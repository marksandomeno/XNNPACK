    ...
    size_t block_height)
{
  ...
  do {
    ...
    for (; bh >= 8; bh -= 8) {
      ...
      i4 = (uint32_t*) ((uintptr_t) i4 + input_offset);
      const __m256i v3_5 = _mm256_maskload_ps((const float*) i5, vmask);
      i5 = (uint32_t*) ((uintptr_t) i5 + input_offset);
      const __m256i v3_6 = _mm256_maskload_ps((const float*) i6, vmask);
      i6 = (uint32_t*) ((uintptr_t) i6 + input_offset);
      const __m256i v3_7 = _mm256_maskload_ps((const float*) i7, vmask);
      i7 = (uint32_t*) ((uintptr_t) i7 + input_offset);
